...
async function gerarProva(dadosProva) {
  ...
  const chat = model.startChat({
    history: [
      ...
      {
        role: "user",
        parts: [{ text: "Ok, no próximo prompt irei te dar as informações para você gerar a prova como tinha mencionado, e lembre-se de colocar a classe correct nas respostas certas" }],
      },
      {
        role: "model",
